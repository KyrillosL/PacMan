...
public class IA {
	...
	public static int A_Star_cout(Maze maze,PositionAgent depart,PositionAgent but) {
	...
	}public static Map<PositionAgent, PositionAgent> A_Star_chemin(Maze maze,PositionAgent depart,PositionAgent but) {
	    // The set of nodes already evaluated
	    ArrayList<PositionAgent> closedSet = new ArrayList<PositionAgent>();
	   ...
	   public static void main(String[] args) {
		...
		System.out.println("TEST IA: " +IA.A_Star_cout(maze, depart, but));
